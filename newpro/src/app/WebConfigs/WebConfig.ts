export const WebConfig = {
    ...
    PagesName: {
        ...
        AdminDashboard:"school-dashboard-page",
    ...
    audioVideoExtensions: ["mp3",".mp3",'wav','.wav', 'wma','.wma', 'acc','.acc','webm', 'mpg', 'mp2', 'mpeg', 'mpe', 'mpv', 'ogg', 'mp4', 'm4p', 'm4v', 'avi', 'wmv', 'mov', 'qt', 'flv', 'swf', 'avchd', '.webm', '.mpg', '.mp2', '.mpeg', '.mpe', '.mpv', '.ogg', '.mp4', '.m4p', '.m4v', '.avi', '.wmv', '.mov', '.qt', '.flv', '.swf', '.avchd'],
    sortOrderList: [{
