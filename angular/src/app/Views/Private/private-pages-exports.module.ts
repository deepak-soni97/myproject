...
const appRoutes: Routes = [
  {
    ...
    children: [
      ...
      { path: WebConfig.PagesName.Cataloge, component: CatalogPageComponent, canActivate: [AuthGuard] },
      { path: WebConfig.PagesName.TeacherProfile, component: TeacherProfileViewPageComponent, canActivate: [AuthGuard] },
      ...
      { path: WebConfig.PagesName.SavedTopic, component: SavedTopicsPageComponent, canActivate: [AuthGuard] },
      { path: WebConfig.PagesName.FileViewerPage, component: FileViwerPageComponent, canActivate: [AuthGuard] },
      { path: WebConfig.PagesName.changePassword, component: ChangePasswordComponent, canActivate: [AuthGuard] },
      { path: WebConfig.PagesName.StudentProfile, component: StudentProfileViewComponent, canActivate: [AuthGuard] },
      { path: WebConfig.PagesName.StudentProfileEdit, component: StudentProfileEditComponent, canActivate: [AuthGuard] },
