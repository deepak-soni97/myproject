...
import { SharedServiceService, SvcLocalStorageService, SvcAuthenticationService, SvcTopicsService, SvcUsersService, SvcCurriculumsService, SvcGradesService } from '@AppServices';
...
export class StudentProfileEditComponent implements OnInit {
  ...
  onSubmit() {
    debugger;
    console.log(this.findInvalidControls(), this.EditForm.value)
